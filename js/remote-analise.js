...
function buildEmailHtml(supplier, analysisHtml) {
  ...
  const occurrencesSection = occurrenceItems.length
    ? '<ul class="occurrence-list">' + occurrenceItems.join('') + '</ul>'
    : '<p class="empty">Sem ocorrencias registradas nos ultimos atendimentos.</p>';
...
.header{padding:28px 30px;background:#0f172a;color:#f8fafc;}
...
.feedback-body ul{margin-bottom:12px;}
...
.wrapper{padding:30px 16px;}
.content{max-width:640px;margin:0 auto;background:#ffffff;border-radius:18px;box-shadow:0 20px 40px rgba(15,23,42,0.08);overflow:hidden;}
.header{padding:28px 30px;background:#111827;color:#f8fafc;}
.header h1{margin:0;font-size:22px;}
.header p{margin:6px 0 0;font-size:13px;color:rgba(248,250,252,0.75);}
